...
class Backend extends Controller
{
     ...
     */
    protected function returnSuccess($msg = '', $data = null, $code = 200, $type = null, array $header = [])
    {
     ...
     * @param array  $header 发送的 Header 信息
     */
    protected function returnError($msg = '', $data = null, $code = 0, $type = null, array $header = [])
    {
        $this->result($msg, $data, $code, $type, $header);
    }
